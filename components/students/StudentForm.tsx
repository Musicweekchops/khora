    ...
    <form onSubmit={handleSubmit} className="space-y-10 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="space-y-8">
          ...
          <Section title="Facturación (Automatización de Cobros)" accent="bg-emerald-500">
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <Field label="Día de Cobro" icon="📆">
                  <input type="number" min="1" max="31" value={form.payment_day} onChange={e => set("payment_day", e.target.value)} className="input-field" placeholder="Ej: 5" />
                </Field>
              </div>
              <div>
                <Field label="Monto a Cobrar ($ CLP)" icon="💰">
              ...
              <p className="text-[10px] text-neutral-400 font-bold uppercase tracking-wide px-1">
                La cobranza automática inicia pausada (desactivada) por defecto. Podrás activarla desde la ficha del alumno.
              </p>
            </div>
          </Section>
        </div>
