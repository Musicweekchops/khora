...
export default function AcademyBibliotecaPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-semibold text-neutral-900 tracking-tight font-sans">Biblioteca Compartida</h1>
        <p className="text-xs text-neutral-400 mt-0.5 font-sans">Crea colecciones y sube material educativo compartido que todos los profesores de tu academia podrán utilizar.</p>
      </div>

      <AcademyLibrary academyId={academyId} />
    </div>
  )
}
