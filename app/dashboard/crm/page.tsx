        ...
        <div className="flex gap-4 overflow-x-auto pb-6 scrollbar-thin scrollbar-thumb-neutral-200">
          {COLUMNS.map(col => (
            <div
              ...
              className="bg-neutral-50/50 rounded-2xl p-3 flex flex-col min-w-[300px] w-[300px] xl:w-auto xl:flex-1 max-h-[calc(100vh-240px)]"
            >
              {/* Column Header */}
              ...
              <div className="flex-1 overflow-y-auto space-y-3 pr-1 custom-scrollbar">
                {getLeadsForColumn(col.key).map(lead => (
                  <Link key={lead.id} href={`/dashboard/alumnos/detalles?id=${lead.id}`} className="block">
                    <div
                      draggable
                ...
                {getLeadsForColumn(col.key).length === 0 && (
                  <div className="p-6 text-center border-2 border-dashed border-neutral-200 rounded-xl mt-2">
